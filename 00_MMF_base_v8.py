"""MMF_base_v8: Added an option asking user if they want all columns or a
shortened version. Also added the total cost of snacks for each user, and
changed the profit to include snack profit as well.
Jack Andrews
17/03/22
"""
...
def main():
    ...
    # For testing purposes, ask user if they want to see all columns, otherwise
    # display only Ticket, Subtotal, Surcharge and Total columns
